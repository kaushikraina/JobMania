        ...
        protected void onPostExecute(Void v) {
            ...
            if(str.equals("success")) {
                ...
                try {
                    ...
                    AdapterForAppliedJobs adapterForAppliedJobs=new AdapterForAppliedJobs(AppliedJobsActivity.this,ajlo,count);
                    ListView appliedJobsList=(ListView)findViewById(R.id.applied_jobs_list);
                    appliedJobsList.setAdapter(adapterForAppliedJobs);
